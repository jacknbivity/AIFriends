    ...
    <div class="navbar-center w-4/5 max-w-180 flex justify-center">
      <div class="join w-4/5 flex justify-center">
        ...
        <div class="navbar-end">
          ...
          <RouterLink v-if="user.hasPulledUserInfo && !user.isLogin()" :to="{name :'user-account-login-index'}" class="btn btn-ghost text-lg" active-class="btn-activate">
            登录
          </RouterLink>
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-54">
        <ul class="menu w-full grow">
          <li>
            <RouterLink :to="{name: 'homepage-index'}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" active-class="menu-focus" data-tip="首页">
              <HomepageIcon/>
              <span class="is-drawer-close:hidden text-base ml-2 whitespace-nowrap">首页</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="{name: 'friend-index'}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" active-class="menu-focus" data-tip="好友">
              <FriendIcon/>
              <span class="is-drawer-close:hidden text-base ml-2 whitespace-nowrap">好友</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="{name: 'create-index'}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" active-class="menu-focus"  data-tip="创作">
              <CreateIcon/>
